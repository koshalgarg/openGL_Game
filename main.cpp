...
bool checkoverlap(Bar a,Bar b)
{
	if (a.position_x+a.width<b.position_x or b.position_x+b.width<a.position_x or a.position_y+a.height<b.position_y or b.position_y+b.height<a.position_y)
    return true;
	return false;
}

bool check_if_gameover()
{
...
void keyboard(unsigned char key,int x,int y)
{
	...
	/*	if(ball_left)
		...
		/*
	if(ball_up)
	ball.position_y+=ball_ball_velocity;
	
	if(ball_down)
	ball.position_y-=ball_ball_velocity;
			
	ball.position_x-=ball_ball_velocity;
	if(ball.position_x<=20)
		ball.position_x=20;
		*/
	}
